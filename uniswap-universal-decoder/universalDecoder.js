...
function decodeExecute(transactionInput) {
    console.log({data: transactionInput}, "{data: transactionInput}")
    const parsedTx = universalInteface.parseTransaction({data: transactionInput.data});
    ...
    switch (swapCodes[foundFunction]) {
        ...
        case "V3_SWAP_EXACT_OUT": 
            ...
            return {
                ...
                path: extractPathFromV3(decoded[3], true), 
                payerIsUser: decoded[4]
            }
